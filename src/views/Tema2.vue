  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Implementación de las BPG en la producción porcina

    img(src='@/assets/curso/temas/tema2/img1.svg')

    p(data-aos="zoom-in").mt-5 La implementación de las Buenas Prácticas Ganaderas en las unidades productivas porcinas tiene como fin la disminución de los riesgos contaminantes con productos pecuarios de origen biológico, físico, y/o químico, así como el impacto de la actividad pecuaria sobre el medio ambiente, de igual forma se pretende mejorar el bienestar animal y del personal laboral del sector rural. Por lo tanto, dichas actividades hacen parte de un sistema de aseguramiento de calidad e inocuidad en la producción primaria, que tienen como fin la obtención de alimentos sanos e inocuos en los predios con este perfil. Sin embargo, el establecimiento de las BPG necesita del cumplimiento de criterios específicos fundamentados en las políticas marco de dicha implementación. 
    p(data-aos="zoom-in") Se invita a ver la siguiente presentación de la implementación de las BPG en la producción porcina:

    .tarjeta.p-4(style="background-color: #EBE1BF").mb-5(data-aos="fade-left").mt-5
      SlyderA(tipo="b")
        .row
          .col-md-6.mb-4.mb-md-0
            p Las buenas prácticas ganaderas en la producción porcina están reglamentadas a través de la Resolución ICA 76509 del año 2020, por medio de la cual se describen los criterios de cumplimiento, por lo tanto, deben ser evaluadas para cumplir con las BPG.
          ...
          .col-md-6.mb-4.mb-md-0
            ...
            ol.lista-ol
              ...
              li 
                | ● Vacunación
              li 
                | ● Manejo de medicamentos, alimentación y residuos, los cuales deben cumplirse para obtener la certificación.
        ...
        .row.justify-content-center.align-items-center.my-lg-4
          .col-md-6.mb-4.mb-md-0
            p Recuerde que las Buenas prácticas ganaderas son una muestra de la calidad, inocuidad y trazabilidad de los productos primarios de origen animal. Es por esto tan importante que en cada uno de nuestros predios podamos implementar las buenas prácticas de manejo y buenas prácticas de producción que se traducen en las buenas prácticas ganaderas en la producción porcina.
      ...
      .col-10
        .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5(data-aos="fade-left")
          ...
          .bloque-texto-g__texto.p-4
            p.mb-0 Una de las herramientas más utilizadas para realizar el diagnóstico del sistema de producción porcina es sin duda la lista de chequeo, la cual enumera de una manera organizada y consecutiva los procesos y actividades que se realizan, para dar seguimiento e inspeccionar cada uno de ellos con el fin de evaluarlos y ofrecer un concepto acertado de los aciertos y fallas en cada uno. Para esto debe conocerse a fondo y delimitarse el tipo de sistema que se ha adoptado en la producción.
    ...
    TabsC.color-acento-contenido.mt-5
      ...
      .py-3.py-md-4(titulo="Sistema de Producción Intensivo")
        .row
          ...
          .col-md-6
            h4 Sistema de producción intensivo
            p En este sistema el cerdo está en total confinamiento y sus condiciones son artificiales. Esto hace que la explotación sea a un costo menor y se obtenga un máximo rendimiento. 
      .py-3.py-md-4(titulo="Sistema de Producción Semi-Intensivo")
        .row
          .col-md-6.mb-4.mb-md-0
            figure
              img(src='@/assets/curso/temas/tema2/img9.png', alt='')
          .col-md-6
            h4 Sistema de Producción Semi-Intensivo
            p En este tipo de producción se tiene en cuenta tanto la productividad como el bienestar y libertad del animal, combinando en partes iguales los dos anteriores sistemas, es decir, los animales tienen espacios abiertos para habitar, pero con una alimentación tipo intensiva, están semi estabulados por grupos y sectores, en este tipo de sistema se incrementa la producción, sin embargo, esta contrasta con los grandes costos en la mano de obra requerida, lo cual reduce la rentabilidad.

    separador
    .titulo-segundo.color-acento-contenido
      h2 Falencia de la unidad productiva frente a la implementación de BPG  

    p(data-aos="zoom-in") Tras realizar un diagnóstico en las unidades productivas aplicando la lista de chequeo se pueden identificar las falencias en los procesos, procedimientos, protocolos o actividades desarrolladas, los cuales deben determinar en qué punto y cómo afectan la unidad productiva, sobre todo en la implementación de las buenas prácticas ganaderas.
    ...
    .row.justify-content-center.mt-5
      .col-10
        .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5(data-aos="fade-left")
          ...
          .bloque-texto-g__texto.p-4
            p.mb-0 Al identificar los errores dentro del proceso de implementación deben tomarse las medidas necesarias para subsanar dichas falencias, planteando posibles soluciones que hagan mejorar y corregir lo que pueda estar fallando, designando responsables, los recursos necesarios y estableciendo un tiempo para que se ponga en marcha lo planteado.

    separador
    .titulo-segundo.color-acento-contenido
      h2 Identificar soluciones    

    p(data-aos="zoom-in") Identificar soluciones requiere de que se tenga determinado y bien reconocidas cada una de las posibles causas de los errores que se presentan en la implementación de las Buenas Prácticas Ganaderas (BPG) en las unidades productivas porcinas, seguidamente a través de reuniones con los equipos asignados a implementar los procesos, procedimientos, planes y protocolos se concreta qué hacer y cómo hacerlo, estableciendo un plan de acción que permita ejecutar las actividades tendientes a corrección de las falencias presentadas y se asignan los equipos responsables.
    p(data-aos="zoom-in") Las soluciones deben ser concretas, precisas y claras para que todos los involucrados puedan entenderlas y ayudar a ponerlas en marcha, además todo el personal debe estar enterado de las labores a desarrollar y cómo estarán involucrados para que se ejecuten con éxito las soluciones, además estás deben monitorearse con el fin de evaluar los avances a corto, mediano y largo plazo a través de su implementación.
